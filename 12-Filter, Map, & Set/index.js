//const team = ["Mbappe", "Vinicius", "Jude", "Fede", "Arda", "Rodrygo", "Tchouameni"]
...
const ucl = [15,7,6,6,5,4,3,3,2]

//const champ = ucl.filter ((number)=>number>=5)
//console.log(champ)
...
//const squad  = realMadrid.filter ((realMadrid)=>realMadrid.matches>50).sort((a,b)=>b.matches-a.matches);
//const goalContribution = realMadrid.filter((realMadrid)=>realMadrid.goals>10).sort((a,b)=>b.goals-a.goals)
//console.log(goalContribution)
//const season = realMadrid.map((realMadrid)=>({name:realMadrid.name,matches:realMadrid.matches}))
//const playerprofile = realMadrid.map((realMadrid)=>({name:realMadrid.name, kit:realMadrid.kit}))
//console.log(season)
let totalGoals = realMadrid.reduce((accumulator,currenValue)=>{
      return accumulator+currenValue.goals
},0);
//console.log(totalGoals)

const arr = [5,4,4,3,2,2,1,1,]
let wc = new Set(arr)
console.log(wc)
